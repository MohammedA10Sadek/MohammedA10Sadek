...
<head>
    ...
    <title>Mohammed Ali Sadek Abdallah - README</title>
    <style>
        body {
        ...
        .skills ul, .projects ul, .activities ul {
            list-style-type: none;
            padding: 0;
        }
        .skills li, .projects li, .activities li {
            background: #0073b1;
            color: #fff;
            margin: 5px 0;
            padding: 10px;
        ...
        .projects li:hover, .activities li:hover {
            background: #005b8a;
        }
        .projects a, .activities a {
            color: #fff;
            text-decoration: none;
        }
    </style>
